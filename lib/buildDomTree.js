...
(function() {
  ...
  function buildDomTree(options = {}) {
    ...
    for (const el of elements) {
      ...
      // Add position hint for input elements to help model use click_at if needed
      if ((actualElement?.isContentEditable || el.attributes.role === 'textbox' || el.tagName === 'input' || el.tagName === 'textarea') && el.rect) {
